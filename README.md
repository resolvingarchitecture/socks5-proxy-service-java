[![Build Status](https://travis-ci.com/resolvingarchitecture/socks5-proxy-service-java.svg?branch=master)](https://travis-ci.com/resolvingarchitecture/socks5-proxy-service-java)
